...
svg(
  ...
  //- Move everything so that elasticity can go outside viewbox
  ...
  mounted() {
    if (this.animate === true) {
      ...
      setTimeout(() => {
        anime({
          targets: 'svg .footer',
          easing: 'cubicBezier(0.230, 1, 0.885, 0.975)',
          duration: 1000,
          translateX: [
            el => el.getAttribute('data-x'),
            el => el.getAttribute('data-x')
          ],
          translateY: [100, el => el.getAttribute('data-y')]
        })
      }, 2000)
    } else {
      anime({
